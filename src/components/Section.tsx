...
function Header() {
  ...
  return (
   ...
   <section className=" grid lg:grid-cols-2 grid-cols-1  ">
      ...
      <div className="bg-blue-300 text-center text-xl  text-white lg:pt-60 lg:text-3xl font-semibold h-96 lg:h-full">
        ...
        <h5 className=" lg:text-left lg:pl-10 text-lg font-semibold ">-Vivian M'soka</h5>
        <h4 className=" lg:text-left lg:pl-12 text-lg">Director of Administration</h4>
