...
import TradeGallery from '../components/Gallery/TradeGallery'
...
const Trade = () => {
    return (
      ...
      <div className="lg:order-last order-first">
          <img
            src={process.env.PUBLIC_URL + "/assets/car2.jpg"}
        ...
        <div className=" lg:rounded-tr-3xl lg:rounded-br-3xl  bg-gray-50 text-center   text-black lg:pt-10 lg:text-md  h-full lg:h-full">
         <h1 className="text-left text-2xl lg:text-6xl text-blue-400 ml-10 ">Trade</h1>
