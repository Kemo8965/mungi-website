...
function About() {
  const img1=`${process.env.PUBLIC_URL + '/assets/mungi-logo.png'}`
  return (
    <div>

         
   <div className="text-center justify-items-left ml-20 py-8 px-8 bg-white shadow-lg rounded-lg my-20">
   ...
   <section className=" grid lg:grid-cols-2 grid-cols-1 gap-y-3 ">
     ...
     <Parallax className="lg:object-cover h-72 object-contain lg:pt-36 lg:w-full lg:h-100 lg:pb-8" bgImage={img1}>
     ...
     <div className="bg-blue-400 text-center font-serif text-blue-200 lg:pt-24 lg:text-xl font-semi-bold h-96 lg:h-100">
